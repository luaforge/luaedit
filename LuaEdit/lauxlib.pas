(*
** $Id: lauxlib.pas,v 1.1 2005-04-02 16:25:27 jfgoulet Exp $
...
//function luaL_findstring(const ST: PChar; const char *const lst[]): Integer;
...
procedure luaL_argcheck(L: Plua_State; Cond: Boolean; NumArg: Integer; const ExtraMsg: PChar);
