...
procedure TfrmLuaConsole.vstLuaOutputGetText(Sender: TBaseVirtualTree; Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var CellText: WideString);
var
  pData: PLuaOutputLine;
begin
  case Column of
...
procedure TfrmLuaConsole.vstLuaOutputGetNodeDataSize(Sender: TBaseVirtualTree; var NodeDataSize: Integer);
begin
...
procedure TfrmLuaConsole.vstLuaOutputDblClick(Sender: TObject);
begin
