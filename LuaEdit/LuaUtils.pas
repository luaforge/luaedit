...
uses
  SysUtils, Classes, ComCtrls, lua, lualib, lauxlib;
...
uses
  Dialogs, LuaOutput{Added for LuaEdit purposes};
...
begin
  ...
  begin
    ...
    frmLuaOutput.rtfOutput.Lines.Add(String(S));
    if (S = nil) then
    begin
